...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final name = AppMockState.activeUser?.name ?? "John Doe";
    final age = AppMockState.activeUser?.age ?? "--";
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        AppMockState.connectedDevice ?? "Not connected",
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: AppMockState.connectedDevice != null
                              ? Colors.black87
                  ...
                  if (AppMockState.connectedDevice != null) ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${AppMockState.selectedSampleRate} Hz",
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.black87,
