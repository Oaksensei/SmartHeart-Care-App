...
public class ECGActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private void enableHRSubscription() {
        ...
        String strContract = sb.append("{\"Uri\": \"").append(connectedSerial).append(URI_MEAS_HR).append("\"}")
                .toString();
                ...
                strContract, new MdsNotificationListener() {
                    ...
                    public void onNotification(String data) {
                        ...
                        if (hrResponse != null) {
                            ...
                            ((TextView) findViewById(R.id.textViewIBI)).setText(hrResponse.body.rrData.length > 0
    ...
    private void enableECGSubscription() {
        ...
        String strContract = sb.append("{\"Uri\": \"").append(connectedSerial).append(URI_ECG_ROOT).append(sampleRate)
                .append("\"}").toString();
        Log.d(LOG_TAG, strContract);
        // Clear graph
